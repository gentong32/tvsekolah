<?php 
	...
	$arg1 = $_GET['idlo'];
if (($_SESSION['udahlogin']==true) && ($_SESSION['username']!=''))
{	
	?>
<!DOCTYPE html>
<html lang="en">
...
<object data="../file_storage/learning_object/lo<?php echo $arg1 ?>/story_html5.html" class="objek" style="overflow:hidden;padding:0;margin:0;top:0;right:0;width:880px;height:480px;" type="text/html">
</object>
