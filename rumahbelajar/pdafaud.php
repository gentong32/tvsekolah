...
$database->query("SELECT iddaftarvideo as idbahanajar,ikon as ikonbahanajar,nmvideo as judulmateri,sinopsis,nmkatvideo FROM daftarvideo a 
...
<a class="hovertext2" target="_blank" href="tampilajar.php?ver=0&idmateri=<?php echo $idmapel[$i] ?>" sinopsis="<?php echo $sinopsis[$i] ?>">
...
<audio controls width="100px" height="50px">
  <source src="..\file_storage\video_belajar\paud\<?php echo $ikonmapel[$i];?>.mp3" type="audio/mpeg">
