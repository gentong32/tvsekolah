...
if(valOptions=="")
{
window.open("index.php?idkelas=0","_self");
}
else
window.open("index.php?cari="+valOptions+"&idkelas=0", "_self");
}
...
<div id="logo"> <a href="http://belajar.kemdikbud.go.id"><img src="logo_rumah_belajar.png" width="315" height="70"></a>
</div>
...
<div id="cari" style="left: <?php if ($arg1>0 && $arg1<99 || $arg1=='') echo '613px'; else echo '740px';?>">
...
<?php } else if($arg1=="0")
{?>
<div class="floatingkelas">Video Pembelajaran PAUD </div>
