...

{
	...
	$cekcari5="WHERE za2.setatus=3 AND za2.topik LIKE :fcari";
	$cekcari6="WHERE za3.setatus=3 AND za3.topik LIKE :fcari";
	}
	else
	{
	...
	$cekcari5="WHERE za2.setatus=3 AND za2.IDkelas=:fkelas AND za2.topik LIKE :fcari";
	$cekcari6="WHERE za3.setatus=3 AND za3.IDkelas=:fkelas AND za3.topik LIKE :fcari";
	}
}
...
".$cekcari4."
UNION 
SELECT iddaftarlo as idbahanajar,ikon as ikonbahanajar,topik as judulmateri,zb2.IDmatapelajaran as IDmapel,sinopsis,40 as versi FROM daftarlo za2 
LEFT JOIN a_standarkompetensi zb2 ON za2.idsk=zb2.IDsk 
LEFT JOIN tmatapelajaran zc2 ON zb2.IDmatapelajaran=zc2.IDmatapelajaran 
".$cekcari5." 
UNION 
SELECT iddaftarkonweb as idbahanajar,ikon as ikonbahanajar,topik as judulmateri,zb3.IDmatapelajaran as IDmapel,sinopsis,41 as versi FROM daftarkonweb za3 
LEFT JOIN a_standarkompetensi zb3 ON za3.idsk=zb3.IDsk 
LEFT JOIN tmatapelajaran zc3 ON zb3.IDmatapelajaran=zc3.IDmatapelajaran 
".$cekcari6."
...
".$cekcari4." 
UNION 
SELECT iddaftarlo as idbahanajar,ikon as ikonbahanajar,topik as judulmateri,zb2.IDmatapelajaran as IDmapel,sinopsis,NMmatapelajaran,40 as versi,za2.IDkelas as IDkelas FROM daftarlo za2
LEFT JOIN a_standarkompetensi zb2 ON za2.idsk=zb2.IDsk 
LEFT JOIN tmatapelajaran zc2 ON za2.IDmatapelajaran=zc2.IDmatapelajaran 
".$cekcari5." 
UNION 
SELECT iddaftarkonweb as idbahanajar,ikon as ikonbahanajar,topik as judulmateri,zb3.IDmatapelajaran as IDmapel,sinopsis,NMmatapelajaran,41 as versi,za3.IDkelas as IDkelas FROM daftarkonweb za3
LEFT JOIN a_standarkompetensi zb3 ON za3.idsk=zb3.IDsk 
