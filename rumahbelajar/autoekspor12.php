...
<LINK href="MO_files/special.css" rel="stylesheet" type="text/css">
<script language="javascript" type="text/javascript" src="MO_files/ajar.js"></script>
</head>
<body">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="79%"><img src="MO_files/logo_rumah_belajar.png" width="315" height="70"></td>
    <td width="21%"><img src="MO_files/logoOER70.png" width="201" height="70"></td>
  </tr>
</table>
</div>
...
<p class="subjudul">&nbsp;</p>
<div id="isikonten">';
$isimateribaris0=str_replace('src="../file_storage/modul_online/MO_'.$arg5.'/Image/','src="MO_files/',$isimateribaris[1]);
$isimateribaris0=str_replace('src="../file_storage/modul_online/MO_'.$arg5.'/Flash/','src="MO_files/',$isimateribaris0);
...
<p class="subjudul">&nbsp;</p>
<div id="isikonten">';
$isimateribaris0=str_replace('src="../file_storage/modul_online/MO_'.$arg5.'/Image/','src="',$isimateribaris[$a]);
$isimateribaris0=str_replace('src="../file_storage/modul_online/MO_'.$arg5.'/Flash/','src="',$isimateribaris0);
...
$isizip8='
<p>&nbsp;</p>
<p align="center"><img src="MO_files/line_title.png" width="600" height="2" class="judul"><br>
</p>
</div>
';
