...
UNION 
SELECT DISTINCT NMmatapelajaran,za2.IDmatapelajaran as IDmapel FROM daftarlo za2 
LEFT JOIN tmatapelajaran zc ON za2.IDmatapelajaran=zc.IDmatapelajaran 
WHERE za2.IDkelas= :fkelas AND za2.IDmatapelajaran>0
