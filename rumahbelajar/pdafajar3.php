<?php
$database->query("
SELECT IDmateripokok as idbahanajar,IMGmateripokok as ikonbahanajar,NMmateripokok as judulmateri,a.IDmatapelajaran as IDmapel,DESCmateripokok as sinopsis,versi FROM tmateripokok a 
LEFT JOIN tmatapelajaran b ON a.IDmatapelajaran=b.IDmatapelajaran 
WHERE a.status='Y' AND IDkelas=:fkelas AND a.IDmatapelajaran=:fmapel    
UNION 
...
WHERE xa.setatus=3 AND xb.IDkelas=:fkelas AND xb.IDmatapelajaran=:fmapel 
UNION
...
WHERE ya.status='Y' AND ya.IDkelas=:fkelas AND ya.IDmatapelajaran=:fmapel  
UNION 
...
WHERE za.setatus=3 AND zb.IDkelas=:fkelas AND zb.IDmatapelajaran=:fmapel 
UNION 
...
WHERE za2.setatus=3 AND za2.IDkelas=:fkelas AND za2.IDmatapelajaran=:fmapel 
UNION 
...
WHERE za3.setatus=3 AND za3.IDkelas=:fkelas AND za3.IDmatapelajaran=:fmapel");

$database->bind(':fkelas',$arg1);
$database->bind(':fmapel',$arg3);
...
<div id="mapelgambar" class="warnajudulgambar<?php if ($arg1>=1 && $arg1<=6) 
	...
	echo '4';
	?>"><div class="infomapel"><?php echo $arg2?></div><div class="infokelas">Kelas 
	<?php 
	if ($arg1>10) 
	{
		echo ($arg1-3)." (SMK)";
