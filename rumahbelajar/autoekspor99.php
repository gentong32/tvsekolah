...
<LINK href="PP_files/special.css" rel="stylesheet" type="text/css">
<script language="javascript" type="text/javascript" src="PP_files/ajar.js"></script>
</head>
<body">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="79%"><img src="PP_files/logo_rumah_belajar.png" width="315" height="70"></td>
    <td width="21%"><img src="PP_files/logoOER70.png" width="201" height="70"></td>
  </tr>
</table>
</div>
...
<p class="subjudul">'.$judulMateri[0].'</p>
<p class="subjudul">&nbsp;</p>
<div id="isikonten">';
$isimateribaris0=str_replace('"../file_storage/pengetahuan_populer/PP_'.$arg5.'/Image/','"PP_files/',$isiMateri[0]);
$isimateribaris0=str_replace('"../file_storage/pengetahuan_populer/PP_'.$arg5.'/Flash/','"PP_files/',$isimateribaris0);
...
<div id="konten"> 
<p align="center" class="judul">&nbsp;</p>
<p class="subjudul">'.$judulMateri[$a].'</p>
<p class="subjudul">&nbsp;</p>
<div id="isikonten">';
$isimateribaris0=str_replace('"../file_storage/pengetahuan_populer/PP_'.$arg5.'/Image/','"',$isiMateri[$a]);
$isimateribaris0=str_replace('"../file_storage/pengetahuan_populer/PP_'.$arg5.'/Flash/','"',$isimateribaris0);
...
if ($isiMateri<>"")
	{
	$isimateribaris0=$isiMateri;
	}
	else
	{
	$isimateribaris0=$isiSingleMateri[0];
	}
	
$isimateribaris0=str_replace('"../file_storage/pengetahuan_populer/PP_'.$arg5.'/Flash/','"PP_files/',$isimateribaris0);
$isimateribaris0=str_replace('"../file_storage/pengetahuan_populer/PP_'.$arg5.'/','"PP_files',$isimateribaris0);
...
$isizip8='
<p>&nbsp;</p>
<p align="center"><img src="PP_files/line_title.png" width="600" height="2" class="judul"><br>
</p>
</div>
';
