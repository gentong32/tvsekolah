...
<LINK href="MP_files/special.css" rel="stylesheet" type="text/css">
<script language="javascript" type="text/javascript" src="MP_files/ajar.js"></script>
</head>
<body">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="79%"><img src="MP_files/logo_rumah_belajar.png" width="315" height="70"></td>
    <td width="21%"><img src="MP_files/logoOER70.png" width="201" height="70"></td>
  </tr>
</table>
</div>
...
<p class="subjudul">&nbsp;</p>
<div id="isikonten">';
$isimateribaris0=str_replace('"../file_storage/materi_pokok/MP_'.$arg5.'/Image/','"MP_files/',$isimateribaris[1]);
$isimateribaris0=str_replace('"../file_storage/materi_pokok/MP_'.$arg5.'/Flash/','"MP_files/',$isimateribaris0);
...
<p class="subjudul">&nbsp;</p>
<div id="isikonten">';
$isimateribaris0=str_replace('"../file_storage/materi_pokok/MP_'.$arg5.'/Image/','"',$isimateribaris[$a]);
$isimateribaris0=str_replace('"../file_storage/materi_pokok/MP_'.$arg5.'/Flash/','"',$isimateribaris0);
...
if ($isiMateri<>"")
	...
	{
	$isimateribaris0=$isiSingleMateri[1];
	}
	
$isimateribaris0=str_replace('"../file_storage/materi_pokok/MP_'.$arg5.'/Flash/','"MP_files/',$isimateribaris0);
$isimateribaris0=str_replace('"../file_storage/materi_pokok/MP_'.$arg5.'/','"MP_files',$isimateribaris0);
...
$isizip8='
<p>&nbsp;</p>
<p align="center"><img src="MP_files/line_title.png" width="600" height="2" class="judul"><br>
</p>
</div>
';
