(function($) {
	...
	if($('header').hasClass("has-topbar")){
     ...
     function load_owl() {
        ...
        jQuery("#collection-carousel-1").owlCarousel({
            center: false,
            items:4,
            loop:true,
            margin:25,
		 ...
		 jQuery("#collection-carousel-2").owlCarousel({
            center: false,
            items:4,
            loop:true,
            margin:25,
		 ...
		 jQuery("#collection-carousel-3").owlCarousel({
            center: false,
            items:4,
            loop:true,
            margin:25,
		 ...
		 jQuery("#collection-carousel-4").owlCarousel({
            center: false,
            items:4,
            loop:true,
            margin:25,
		 ...
		 jQuery("#collection-carousel-5").owlCarousel({
            center: false,
            items:4,
            loop:true,
            margin:25,
		 ...
		 jQuery("#collection-carousel-6").owlCarousel({
            center: false,
            items:4,
            loop:true,
            margin:25,
		 ...
		 jQuery("#collection-carousel-7").owlCarousel({
            center: false,
            items:4,
            loop:true,
            margin:25,
     ...
     function menu_arrow() {
         ...
         jQuery(".video__item_click").on("click", function() {
             var iteration = $(this).data('iteration') || 1;
             
             switch (iteration) {
                 case 1:
                     var cover = jQuery(this).parent().parent().find('.video__item_extra');
         ...
         $( ".video__item" ).mouseleave(function() {
            var cover = jQuery(this).find('.video__item_extra');
            cover.css("visibility","hidden");
            cover.css("opacity","0");
            jQuery(this).find('.video__item_click').data('iteration', 1);
         });
		 
		 jQuery(".video__item_belumlogin").on("click", function() {
             var iteration = $(this).data('iteration') || 1;
         ...
         jQuery(".video__item_like").on("click", function() {
             var iteration = $(this).data('iteration') || 1;
     ...
     jQuery("#dark-mode").on("click", function() {
        if(jQuery('body').hasClass('dark-scheme')){
            window.location.href = 'https://...html';
        }else{
            window.location.href = 'https://...html';
        }
     });
	 */
     ...
     function de_size() {
         var w;
         jQuery('.video__item_wrap').each(function() {
             w = jQuery(this).css('width');
             jQuery(this).css('height',w);
         });

          $(".video__item_preview").on("load", function() {
            }).each(function() {
              if(this.complete) {
     ...
     function de_countdown() {
         $('.de_countdown').each(function() {
			 ...
			 var me = $(this).data('minute');
			 var s = $(this).data('second');
             $(this).countdown({until: new Date(y, m-1, d, h, me, s)});
         });
    }
