...
if ($asal=="owner")
	$alamat = base_url()."bimbel/soal/tampilkan/".$linklist.$tambahan;
else
	$alamat = base_url()."bimbel/soal/kerjakan/".$linklist;
?>
...
<script>
	...
	//window.open("<?php echo base_url();?>bimbel/soal/tampilkan/<?php echo $linklist;?>","_self");
</script>
