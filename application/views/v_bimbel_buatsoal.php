<link href="<?php echo base_url(); ?>css/soal.css?v2.0" rel="stylesheet">
...
foreach ($dafsoal as $datane) {
	...
	$csoalteks = trim(preg_replace('/\s\s+/', ' ', $datane->soaltxt));
	$csoalteks = preg_replace('~[\r\n]+~', '', $csoalteks);
	$csoalteks = str_replace('\x22', '', $csoalteks);
	$csoalteks = str_replace('"', '\"', $csoalteks);
	$soaltxt[$jml] = $csoalteks;
	...
	$opsinya = trim(preg_replace('/\s\s+/', ' ', $datane->opsiatxt));
	$opsinya = preg_replace('~[\r\n]+~', '', $opsinya);
	$opsinya = str_replace('\x22', '', $opsinya);
	$opsinya = str_replace('"', '\"', $opsinya);
	$opsiatxt[$jml] = $opsinya;

	$opsinya = trim(preg_replace('/\s\s+/', ' ', $datane->opsibtxt));
	$opsinya = preg_replace('~[\r\n]+~', '', $opsinya);
	$opsinya = str_replace('\x22', '', $opsinya);
	$opsinya = str_replace('"', '\"', $opsinya);
	$opsibtxt[$jml] = $opsinya;

	$opsinya = trim(preg_replace('/\s\s+/', ' ', $datane->opsictxt));
	$opsinya = preg_replace('~[\r\n]+~', '', $opsinya);
	$opsinya = str_replace('\x22', '', $opsinya);
	$opsinya = str_replace('"', '\"', $opsinya);
	$opsictxt[$jml] = $opsinya;

	$opsinya = trim(preg_replace('/\s\s+/', ' ', $datane->opsidtxt));
	$opsinya = preg_replace('~[\r\n]+~', '', $opsinya);
	$opsinya = str_replace('\x22', '', $opsinya);
	$opsinya = str_replace('"', '\"', $opsinya);
	$opsidtxt[$jml] = $opsinya;

	$opsinya = trim(preg_replace('/\s\s+/', ' ', $datane->opsietxt));
	$opsinya = preg_replace('~[\r\n]+~', '', $opsinya);
	$opsinya = str_replace('\x22', '', $opsinya);
	$opsinya = str_replace('"', '\"', $opsinya);
	$opsietxt[$jml] = $opsinya;
...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
				<div class="container" style="color:black;max-width: 900px">
					<center><span style="font-size:20px;font-weight:Bold;">SOAL LATIHAN BIMBEL<br><?php echo $judul; ?></span>
					</center>
					<!---->
						...
						<div class="row">
							...
							<div class="form-group" style="margin-top: 10px;">
								...
								<label for="inputDefault" class="col-md-12 control-label">
									<div id="soalnomor" style="text-align: center;font-weight: bold;font-size: larger">
										Buat Pertanyaan
						  ...
						  class="ckeditor" id="iisisoal" name="iisisoal" maxlength="1000"></textarea>
							...
							<form class="form-horizontal" id="submitgbsoal">
								<div class="form-group" style="margin-left: 15px">
									...
									<input style="display:inline;margin-left: 20px;" type="file" name="fgbsoal"
										   id="fgbsoal"
										   accept="image/*">
									<br>
									<button style="display:inline-block;margin-left: 20px;" id="btn_gbsoal"
											type="submit">Terapkan
									</button>
									<button onclick="return hapusgbsoal();"
						  ...
						  class="ckeditor" id="iisiopsia" name="iisiopsia" maxlength="1000"></textarea>
							...
							<form class="form-horizontal" id="submitgbopsia" style="margin-left: 25px;">
								<div class="form-group" style="margin-left: 30px">
									<!--                                <span style="color: #3d773d;font-style:italic ">Klik tombol dibawah ini untuk mengubah foto. Kemudian "Terapkan" </span>-->
									<input style="display:inline;margin-left: 20px;" type="file" name="fgbopsia"
										   id="fgbopsia"
										   accept="image/*">
									<br>
									<button style="display:inline-block;margin-left: 20px;" id="btn_gbopsia"
											type="submit">Terapkan
									</button>
									<button onclick="return hapusgbopsia();"
											style="display:inline-block;margin-left: 20px;"
											id="btn_hapusopsia">
										Hapus
									</button>
                ...
                <textarea style="max-width:800px;width:100%;margin:0;padding:0" type="text"
						  class="ckeditor" id="iisiopsib" name="iisiopsib" maxlength="1000"></textarea>
							...
							<form class="form-horizontal" id="submitgbopsib" style="margin-left: 25px;">
								<div class="form-group" style="margin-left: 30px">
									<!--                                <span style="color: #3d773d;font-style:italic ">Klik tombol dibawah ini untuk mengubah foto. Kemudian "Terapkan" </span>-->
									<input style="display:inline;margin-left: 20px;" type="file" name="fgbopsib"
										   id="fgbopsib"
										   accept="image/*">
									<br>
									<button style="display:inline-block;margin-left: 20px;" id="btn_gbopsib"
											type="submit">Terapkan
									</button>
									<button onclick="return hapusgbopsib();"
											style="display:inline-block;margin-left: 20px;"
											id="btn_hapusopsib">
										Hapus
									</button>
                ...
                <textarea style="max-width:800px;width:100%;margin:0;padding:0" type="text"
						  class="ckeditor" id="iisiopsic" name="iisiopsic" maxlength="1000"></textarea>
							...
							<form class="form-horizontal" id="submitgbopsic" style="margin-left: 25px;">
								<div class="form-group" style="margin-left: 30px">
									<!--                                <span style="color: #3d773d;font-style:italic ">Klik tombol dibawah ini untuk mengubah foto. Kemudian "Terapkan" </span>-->
									<input style="display:inline;margin-left: 20px;" type="file" name="fgbopsic"
										   id="fgbopsic"
										   accept="image/*">
									<br>
									<button style="display:inline-block;margin-left: 20px;" id="btn_gbopsic"
											type="submit">Terapkan
									</button>
									<button onclick="return hapusgbopsic();"
											style="display:inline-block;margin-left: 20px;"
											id="btn_hapusopsic">
										Hapus
									</button>
                ...
                <textarea style="max-width:800px;width:100%;margin:0;padding:0" type="text"
						  class="ckeditor" id="iisiopsid" name="iisiopsid" maxlength="1000"></textarea>
							...
							<form class="form-horizontal" id="submitgbopsid" style="margin-left: 25px;">
								<div class="form-group" style="margin-left: 30px">
									<!--                                <span style="color: #3d773d;font-style:italic ">Klik tombol dibawah ini untuk mengubah foto. Kemudian "Terapkan" </span>-->
									<input style="display:inline;margin-left: 20px;" type="file" name="fgbopsid"
										   id="fgbopsid"
										   accept="image/*">
									<br>
									<button style="display:inline-block;margin-left: 20px;" id="btn_gbopsid"
											type="submit">Terapkan
									</button>
									<button onclick="return hapusgbopsid();"
											style="display:inline-block;margin-left: 20px;"
											id="btn_hapusopsid">
										Hapus
									</button>
                ...
                <textarea style="max-width:800px;width:100%;margin:0;padding:0" type="text"
						  class="ckeditor" id="iisiopsie" name="iisiopsie" maxlength="1000"></textarea>
							...
							<form class="form-horizontal" id="submitgbopsie" style="margin-left: 25px;">
								<div class="form-group" style="margin-left: 30px">
									<!--                                <span style="color: #3d773d;font-style:italic ">Klik tombol dibawah ini untuk mengubah foto. Kemudian "Terapkan" </span>-->
									<input style="display:inline;margin-left: 20px;" type="file" name="fgbopsie"
										   id="fgbopsie"
										   accept="image/*">
									<br>
									<button style="display:inline-block;margin-left: 20px;" id="btn_gbopsie"
											type="submit">Terapkan
									</button>
									<button onclick="return hapusgbopsie();"
											style="display:inline-block;margin-left: 20px;"
											id="btn_hapusopsie">
										Hapus
									</button>
							...
							echo form_open('bimbel/updatesoal/' . $linklist, $attributes);
							?>
					...
					<div style="margin-bottom: 15px;">
						Jika semua soal sudah dibuat, silakan klik tombol <b>Seting Soal</b> untuk mengubah Status Soal menjadi
						<b>"Publish"</b> agar bisa diakses.
					</div>
					<div id="dmenubawah" style="margin-left:25px;margin-bottom: 30px;">
						<button class="btn btn-danger" onclick="return kembalibimbel();">Kembali ke Modul Bimbel
						</button>
...
<script>
	...
	function uploadgbr(idx, field, data) {
		$('#loading' + idx).show();
		$.ajax({
			url: '<?php echo base_url(); ?>bimbel/upload_gambarsoal/<?php echo $linklist;?>/' + pilihan + '/' + idx + '/' + field,
			type: "post",
			data: data,
			processData: false,
			contentType: false,
	...
	function ditambah() {
		...
		$.ajax({
			...
			dataType: 'json',
			cache: false,
			url: '<?php echo base_url();?>bimbel/insertsoal/<?php echo $linklist;?>',
	...
	function dibatal() {
		...
		if (soalbaru == 1) {
			$.ajax({
				url: "<?php echo base_url();?>bimbel/delsoal",
				method: "POST",
	...
	function cekupdate() {
		...
		// alert ("OPSI:"+$('#adagbsoal').val()+":"+$('#adagbopsia').val()+","+$('#adagbopsib').val()+","+
		// 	$('#adagbopsic').val()+","+$('#adagbopsid').val()+","+$('#adagbopsie').val());
	...
	function kembalibimbel() {
		<?php if (get_cookie('basis')=="event")
		{?>
			window.open("<?php echo base_url();?>event/videomodul/<?php echo $linklist;
			if ($kodeevent != null) echo '/' . $kodeevent;?>", "_self");
		<?php }
		else
		{ ?>
		window.open("<?php echo base_url();?>bimbel/inputplaylist_bimbel<?php
			if ($linklist != null) echo '/' . $linklist;?>", "_self");
		<?php } ?>
	}

	function setingsoal() {
		window.open("<?php echo base_url();?>bimbel/soal/seting/<?php echo $linklist;
			if ($kodeevent != null) echo '/' . $kodeevent;?>", "_self");
	}

	function lihatsoal() {
		if (jmlsoal > 0)
			window.open("<?php echo base_url();?>bimbel/soal/<?php echo $linklist . '/' . $asal;
				if ($kodeevent != null) echo '/' . $kodeevent; ?>", "_self");
		else
	...
	function lihatnilai() {
		window.open("<?php echo base_url();?>bimbel/soal/nilaisiswa/<?php echo $linklist;?>", "_self");
	}

	function jump(h) {
		var top = document.getElementById("angker").offsetTop;
