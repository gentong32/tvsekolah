...
if ($this->session->userdata("tutor") < 2)
	$ceksiae = "block";
else
	$ceksiae = "none";
		...
		<div class="container" style="max-width: 600px;margin: auto;">
			<div class="row">
				...
				<div class="cd-tabs cd-tabs--vertical js-cd-tabs"
                    ...
                    margin-bottom:5px;display:<?php echo $inlineawal; ?>" id="tbkembali" class="myButton1">Kembali
						</button>
                    ...
                    <a href=\"#tab-new\" class=\"cd-tabs__item\">
                        ...
                        <span>Porto</span>
							...
							} else if ($userData['sebagai'] == 1 || $userData['sebagai'] == 2) {
								echo "<li>
                    <a href=\"#tab-new\" class=\"cd-tabs__item\">
                        <!--                        <svg aria-hidden=\"true\" class=\"icon icon--xs\"><path d=\"M12.7,0.3c-0.4-0.4-1-0.4-1.4,0l-7,7C4.1,7.5,4,7.7,4,8v3c0,0.6,0.4,1,1,1h3 c0.3,0,0.5-0.1,0.7-0.3l7-7c0.4-0.4,0.4-1,0-1.4L12.7,0.3z M7.6,10H6V8.4l6-6L13.6,4L7.6,10z\"></path><path d=\"M15,10c-0.6,0-1,0.4-1,1v3H2V2h3c0.6,0,1-0.4,1-1S5.6,0,5,0H1C0.4,0,0,0.4,0,1v14c0,0.6,0.4,1,1,1h14 c0.6,0,1-0.4,1-1v-4C16,10.4,15.6,10,15,10z\"></path></svg>-->
                        <span>Sekolah</span>
...
<!--							--><?php //} ?>
					...
					<ul class="cd-tabs__panels">
						...
						<textarea <?php echo $readonlyawal; ?> rows="4" cols="60" class="form-control" id="ialamat"
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input <?php echo $readonlyawal; ?> type="text" class="form-control" id="inpwp"
																		name="inpwp"
																		maxlength="25" value="<?php
						...
						<li id="tab-new" class="cd-tabs__panel text-component">
							<div id="dkantor" style="padding-bottom:20px;display:<?php
							if ($userData['sebagai'] == 3 || $userData['sebagai'] == 4) echo 'block';
								...
								<div class="form-group" id="dpropinsi" style="width: 100%;">
									...
									<div class="col-md-12" style="padding-bottom:10px;width: 100%">
										<select <?php
										if ($this->session->userdata('sebagai') == 3 && $userData['kd_kota']!=0
								...
								<div class="form-group" id="dkota" style="width: 100%;">
					...
					<div class="container">
						<div class="row">
							<div>
								<button style="display:<?php echo $inlineawal2; ?>" id="tbbatal" type="submit"
										class="btn-main" onclick="return gaksido()">Batal
								</button>
								<button style="display:<?php echo $inlineawal2; ?>" id="tbupdate" type="submit"
										class="btn-main" onclick="return cekupdate()">Update
								</button>
							</div>
...
<script>
	...
	function diedit() {
		...
		<?php if (($this->session->userdata('bimbel') == 3 && ($userData['kd_kota']==0
		|| $userData['kd_kota']==null)) || $this->session->userdata('bimbel') == 2) {?>
		document.getElementById('ipropinsi').disabled = false;
		document.getElementById('ikota').disabled = false;
		<?php } ?>
	...
	function jump() {
		var top = document.getElementById('inpwp').offsetTop;
