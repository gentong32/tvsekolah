	...
	<div class="no-bottom no-top" id="content">
		...
		<section aria-label="section" class="mt0 sm-mt-0">
			<div class="container">
				<div class="row">
					<center>
						<h4>ANDA BELUM MEMILIKI VIDEO (PRIBADI)</h4>

						<br>

						<h5>Silakan Tambahkan Video pada menu Daftar Video Saya atau melalui Upload Video pada
							Event.<br>
							Kemudian pada kolom Sifat diubah dari Publik menjadi Pribadi terlebih dahulu.<br><br>
							Untuk dapat tampil pada Channel Guru pastikan Video anda statusnya sudah Siap Tayang.
							Mintalah Verifikator Sekolah agar Video anda diverifikasi. </h5>
					</center>
				</div>
			</div>
		</section>
		...
		<div class="container">
			<div class="row">
				<div style="margin-bottom: 10px;">
					...
					<button class="btn-main" onclick="return kembali();"
				...
				<center>
					<h3>Masukkan Video untuk Paket Playlist <?php echo $namapaket; ?></h3>
				</center>

				<div style="margin-bottom: 10px;">
					<button
						onclick="window.location.href='<?php echo base_url(); ?>ekskul/urutanplaylist/<?php echo $kodepaket; ?>'"
						class="btn-main" style="float:right;margin-right:10px;margin-top:-20px;">Atur Urutan
					</button>
				</div>
...
<script>
	...
	function gantisifat(idx) {
		...
		$.ajax({
			url: "<?php echo base_url();?>ekskul/gantisifat",
			method: "POST",
	...
	function masukinlist(idx) {
		...
		$.ajax({
			url: "<?php echo base_url();?>ekskul/masukinlist",
			method: "POST",
