						...
						<a href="<?php echo $linkmentor;?>">
							<div class="full counter_section margin_bottom_30">
								...
								<div class="counter_no">
									<div>
										<p class="total_no"><?php echo $totalmentor;?></p>
										<p class="head_couter">Jumlah Seluruh Mentor</p>
									</div>
								</div>
							</div>
						</a>
						...
						<div class="col-md-6 col-lg-3">
							<a href="<?php echo $linktutor;?>">
								<div class="full counter_section margin_bottom_30">
									...
									<div class="counter_no">
										<div>
											<p class="total_no"><?php echo $jmlcalontutor." / ".$totaltutor;?></p>
											<p class="head_couter">Calon Tutor perlu diverifikasi</p>
										</div>
									</div>
								</div>
							</a>
					...
					<div class="col-md-6 col-lg-3">
						<a href="<?php echo $linktutor;?>">
							<div class="full counter_section margin_bottom_30">
								...
								<div class="counter_no">
									<div>
										<p class="total_no"><?php echo $totaltutor;?></p>
										<p class="head_couter">Jumlah Seluruh Tutor</p>
									</div>
								</div>
							</div>
						</a>
						...
						<div class="col-md-6 col-lg-3">
							<a href="<?php echo $linkvideo;?>">
								<div class="full counter_section margin_bottom_30">
									<div class="couter_icon">
										<div>
											<i class="fa fa-youtube-play blue1_color"></i>
										</div>
									</div>
									<div class="counter_no">
										<div>
