...
echo form_open('vksekolah/updateseting/' . $linklist, $attributes);
?>

<div class="container" style="color:black;margin-top: 60px; max-width: 900px">
	<center><span style="font-size:20px;font-weight:Bold;">Seting Soal Latihan<br><?php echo $judul; ?></span></center>
	<br>
