...
foreach ($dafkomentar as $datane) {
	if ($datane->id_parent == 0) {
		...
		$tglkirim[$jml_induk][0] = namabulan_panjang($datane->created);
	...
	<div id="myModal" class="Modal is-hidden is-visuallyHidden">
		...
		<div class="Modal-content">
			<?php if ($this->session->userdata('loggedIn')) { ?>
				<center>
				<p style="margin-top: 10px;">Bagikan link</p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="indukplay" style="text-align:center;margin-left:auto;margin-right: auto;">
					<div id="isivideoyoutube" style="text-align:center;width:100%;display:inline-block">
						<?php
						if ($datavideo['link_video'] != "") {
							if ($datavideo['thumbnail'] != "https://img.youtube.com/vi/false/0.jpg") { ?>

<!--								<iframe class="embed-responsive-item" width="500" height="375"-->
...
<!--											</div>-->
						...
						<div style="color:black;float:left; margin-right:0px">
							...
							<div style="display:inline" id="bagikan">
								<?php if ($this->session->userdata('loggedIn')) { ?>
									<a href="#" onclick="return bukamodal()"><span
											style="color:black;">Bagikan</span></a>
								<?php } else { ?>
							  ...
							  placeholder="Tulis komentar ..."></textarea>
									<div id="tb_komen" style="display:none">
										...
										<button type="submit" class="btn btn-primary"
												onclick="return kirim_komen(0,0)">Kirim
										</button>
									</div>
								</div>
							<?php } else { ?>
