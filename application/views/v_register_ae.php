...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
				<?php
				echo form_open('login/tambahuser_umum/ae', array('autocomplete' => 'off', 'id' => 'myform'));
				...
				<div class="container" style="max-width:600px;padding-bottom: 20px;	">
					<div>
						<legend><span
								style="font-weight: bold;color: black">Mendaftar Sebagai Account Executive</span>
						</legend>
...
<script>
	...
	function takon() {
		window.open("<?php echo base_url();?>peluangkarir/account_executive/", "_self");
		return false;
	}
