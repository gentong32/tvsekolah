...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
				<br>
				<center><span style="font-size:16px;font-weight: bold;">Daftar User AE
        </span></center>
				<br><br>
...
//				continue;
			...
			echo "data.push([ " . $jml_user . ", \"" . $datane->first_name . " " .
				$datane->last_name . "\", \"" . $datane->alamat . "\", \"" .
	...
	function aksi(idnya) {
		window.open("<?php echo base_url() . 'user/aksi/ae/';?>" + idnya + "/", "_self");
	}
