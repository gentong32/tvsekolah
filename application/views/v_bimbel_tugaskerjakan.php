			...
			<div class="row">
				<div class="form-group" style="margin-top: 10px;">
					...
					<label for="inputDefault" class="col-md-12 control-label">
						<div id="soalnomor"
							 style="margin-bottom:15px;text-align: center;font-weight: bold;font-size: larger">Silakan
							Jawab Disini
						</div>
					</label>
...
<script>
	...
	function updatejawaban() {
		...
		$.ajax({
			url: "<?php echo base_url();?>bimbel/updatetugasjawab/<?php echo $linklist;?>",
			method: "POST",
	...
	function lihatjawaban() {
		if (document.getElementById('tbupdate').style.display == "none")
			window.open("<?php echo base_url();?>bimbel/tugas/jawabansaya/<?php echo $linklist;?>", "_self");
		else
	...
	$('#submitdok').submit(function (e) {
		e.preventDefault();
		$.ajax({
			url: '<?php echo base_url(); ?>bimbel/upload_doktugas/<?php echo $linklist;?>/siswa',
			type: "post",
