				...
				<div id="tabel1" style="font-size:1em;margin-left:1px;margin-right:1px;">
					<table id="tbl_user" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
						...
						<tr>
							...
							<th class='none'>NetFee AG</th>
							<th class='none'>NetFee AM</th>
...
<script>
	...
	$(document).ready(function () {
		...
		foreach ($daftransaksi as $datane) {
			...
			$bersih = $bersih_agency[$jml_user];
			$kode = substr($datane->order_id, 0, 2);

			$bersih2 = $bersih_siam[$jml_user];
			$kode = substr($datane->order_id, 0, 2);
			...
			echo "data.push([ " . $jml_user . ", \"" . substr($datane->tgl_bayar, 0, 10) .
				"\", \"" . $datane->nama_sekolah .
				"\", \"" . $jeniskelas .
