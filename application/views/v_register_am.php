...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
				<?php
				echo form_open('login/tambahuser_umum/am', array('autocomplete' => 'off', 'id' => 'myform'));
				...
				<div class="container" style="max-width:600px;padding-bottom: 20px;	">
					<div>
						<legend><span
								style="font-weight: bold;color: black">Mendaftar Sebagai Area Marketing</span>
						</legend>
						<fieldset style="background-color: white;margin-top: 20px">
							...
							<div class="form-group" style="padding-top: 20px;">
								...
								<div class="col-md-12">
									<input autocomplete="false" autofill="false" type="text" class="form-control"
										   id="iemail" name="iemail" maxlength="50" value="" placeholder="Alamat Email">
							...
							<div class="form-group">
								<label for="inputDefault" class="col-md-12 control-label">Repeat Password<span
										style="color:red">*</span></label>
								<div class="col-md-12" style="width:200px">
									<input type="password" class="form-control" id="ipassword2" name="ipassword2"
										   maxlength="16"
										   value="<?php
							...
							<div class="form-group">
								<div class="col-md-12" style="width:300px;padding-bottom: 20px;">
									<span style="font-style:italic;font-size:smaller;color: red">*) wajib diisi</span>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-md-10 col-md-offset-0" style="margin-bottom: 10px;">
									...
									<button type="submit" class="btn btn-primary" onclick="return cekregister()">Daftar
									</button>
								</div>
							</div>
...
<script>
	...
	function takon() {
		window.open("<?php echo base_url();?>peluangkarir/area_marketing", "_self");
		return false;
	}
