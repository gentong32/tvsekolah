			...
			<div class="row">
				...
				<div style="margin-bottom: 10px;">
					<button class="btn-main"
							onclick="window.location.href='<?php echo base_url().'event/buatmodul/'.$linkevent;?>'">Kembali
					</button>
					<button class="btn-main"
							onclick="window.location.href='<?php echo base_url().'event/spesial/'.$linkevent;?>'	">Video Saya
					</button>
					<?php if ($jml_video > 0) {?>
					<button class="btn-main"
							onclick="window.location.href='<?php echo base_url().$vkataub; ?>/materi/buat/<?php echo $kodepaket;?>'">Materi
					</button>
					<button class="btn-main"
							onclick="window.location.href='<?php echo base_url().$vkataub; ?>/soal/buat/<?php echo $kodepaket.'/'.$linkevent;?>'">Soal Latihan
					</button>
					<button class="btn-main"
							onclick="window.location.href='<?php echo base_url().$vkataub; ?>/tugas/<?php echo $sayavk;?>buat/<?php echo $kodepaket.'/'.$linkevent;?>'">Tugas
					</button>
					<?php } ?>
				</div>
				...
				<hr>
				<?php
				if ($jml_video == 0 AND $namapaket!="UTS") { ?>
					<center>
						<span style="font-size:16px;font-weight: bold;">ANDA BELUM MEMILIKI VIDEO (MODUL)</span>
					</center>
					<br>
					<center>
			<span style="font-size:16px;font-weight: bold;">Silakan Tambahkan Video dengan tombol Video Saya<br>
				Kemudian pada kolom Sifat diubah dari Publik menjadi <?php echo $modulapa;?> terlebih dahulu.<br><br>
			</span>
					</center>
					...
					?>
						...
						<div style="margin-bottom: 10px;">
						<button type="button"
								onclick="window.location.href='<?php echo base_url(); ?>virtualkelas/urutanmodul/<?php echo $kodepaket; ?>'"
								class="btn-main"
...
<script>
	...
	function masukinlist(idx) {
		...
		$.ajax({
			url: "<?php echo base_url();?>channel/masukinlist<?php if($cekbuatmodul==2) echo '_bimbel';?>",
			method: "POST",
