							...
							<div class="LayoutGrid1">
								<div class="row">
									<div class="container" style="color:black; max-width: 900px">
										<center><span
												style="font-size:20px;font-weight:Bold;">URAIAN TUGAS BIMBEL<br><?php echo $judul; ?></span>
										</center>
										<!---->
                ...
                <textarea style="max-width:800px;width:100%;margin:0;padding:0" type="text"
						  ...
						  value="<?php echo $uraian; ?>"></textarea>
												...
												<div style="float:right;margin-bottom:30px;margin-right: 30px;">
													<button style="display: none;" id="tbupdate" type="submit"
												...
												<div class="form-group" style="margin-top: 30px;">
													...
													<div class="col-md-12" style="padding-bottom:10px;width: 100%">
														<select style="width: 200px" class="form-control"
																name="iadafile" id="iadafile">
															<option <?php echo $selfile[1]; ?> value="0">Tidak Ada
															</option>
												...
												?>">
													<div class="form-group" style="margin-left: 5px">
														<div class="col-md-12" style="padding-bottom:10px;width: 100%">
															<input style="width:200px;display:block;margin-left: 20px;"
																   type="file" name="filedok" id="filedok"
																   accept="application/pdf">
															<button style="display:block;margin-left: 20px;"
																	id="btn_uploaddok" type="submit">Upload
															</button>
											...
											<button onclick="return kosonginfile();"
													style="display:none;margin-left: 35px;" id="btn_file">Update
											</button>
											<hr>
											<button style="margin-left:20px;" id="tbbatal" class="btn btn-danger"
													onclick="return kembali()">Kembali
											</button>
											<button class="btn btn-primary" onclick="return lihattugas();">Lihat Tugas
											</button>
										</div>
									</div>
								</div>
...
<script>
	...
	function updatemateri() {
		...
		$.ajax({
			url: "<?php echo base_url();?>bimbel/updatetugas/<?php echo $linklist;?>",
			method: "POST",
	...
	function lihattugas() {
		...
		window.open("<?php echo base_url();?>bimbel/tugas/tampilkan/<?php echo $linklist . $tambahalamat;?>", "_self");
	}

	function kosonginfile() {
		$.ajax({
			url: "<?php echo base_url();?>bimbel/kosonginfiletugas",
			method: "POST",
	...
	$('#submitdok').submit(function (e) {
		e.preventDefault();
		$.ajax({
			url: '<?php echo base_url(); ?>bimbel/upload_doktugas/<?php echo $linklist.$cekevent;?>',
			type: "post",
