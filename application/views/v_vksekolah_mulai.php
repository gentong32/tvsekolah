<?php
if ($asal=="owner")
	$alamat = base_url()."vksekolah/soal/".$npsn."/tampilkan/".$linklist;
else
	$alamat = base_url()."vksekolah/soal/".$npsn."/kerjakan/".$linklist;
?>
...
<script>
	...
	//window.open("<?php echo base_url();?>vksekolah/soal/tampilkan/<?php echo $linklist;?>","_self");
</script>
