		...
		<div class="row column2 graph margin_bottom_30">
			<div class="col-md-l2 col-lg-12">
				<div class="row">
					<div class="col-md-6 col-lg-3">
						...
						<div class="full counter_section margin_bottom_30">
							...
							<div class="counter_no">
								<div>
									<p class="total_no"><?php echo $keteranganuser1;?></p>
									<p class="head_couter"><?php echo $keteranganuser2;?></p>
								</div>
							</div>
						</div>
						</a>
						...
						<div class="col-md-6 col-lg-3">
							<a href="<?php echo $linkae;?>">
								<div class="full counter_section margin_bottom_30">
									...
									<div class="counter_no">
										<div>
											<p class="total_no"><?php echo $jmlcalonae;?></p>
											<p class="head_couter">Calon AE menunggu diverifikasi</p>
										</div>
									</div>
								</div>
							</a>
						...
						<div class="col-md-6 col-lg-3">
							<a href="<?php echo $linkam;?>">
								<div class="full counter_section margin_bottom_30">
									...
									<div class="counter_no">
										<div>
											<p class="total_no"><?php echo $jmlcalonam;?></p>
											<p class="head_couter">Calon AM menunggu diverifikasi</p>
										</div>
									</div>
								</div>
							</a>
						...
						<div class="col-md-6 col-lg-3">
							<a href="<?php echo $linkag;?>">
								<div class="full counter_section margin_bottom_30">
									...
									<div class="counter_no">
										<div>
											<p class="total_no"><?php echo $jmlcalonag;?></p>
											<p class="head_couter">Calon Agency menunggu diverifikasi</p>
										</div>
									</div>
								</div>
							</a>
					...
					<?php if ($jmlsiplahkonfirm>0) { ?>
						<div class="col-md-6 col-lg-3">
							<a href="<?php echo $linksiplah;?>">
								<div class="full counter_section margin_bottom_30">
									<div class="couter_icon">
										<div>
											<i class="fa fa-folder-open red_color"></i>
										</div>
									</div>
									<div class="counter_no">
										<div>
											<p class="total_no"><?php echo $jmlsiplahkonfirm;?></p>
											<p class="head_couter">Bukti SIPLAH perlu diverifikasi</p>
										</div>
									</div>
								</div>
							</a>
						...
						<div class="col-md-6 col-lg-3">
							<a href="<?php echo $linkchn;?>">
								<div class="full counter_section margin_bottom_30">
									<div class="couter_icon">
										<div>
											<i class="fa fa-university green_color"></i>
										</div>
									</div>
									<div class="counter_no">
										<div>
		...
		<div class="row column1">
			...
			<div class="col-md-6 col-lg-3">
				<div class="full counter_section margin_bottom_30">
					...
					<div class="counter_no">
						<div>
							<p class="center">5 Januari 2022</p>
							<p class="head_couter">Batas Tenggang</p>
						</div>
					</div>
				</div>
			</div>
									...
									<div id="testimonial_slider" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner">
											<div class="item carousel-item active">
												<div class="img-box"><img src="images/layout_img/user_img.jpg" alt="">
												</div>
