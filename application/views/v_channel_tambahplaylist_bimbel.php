...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
				<center>
		<span style="font-size:20px;font-weight:normal;"><?php echo $judule; ?> MODUL BIMBEL
			<?php if ($linklist_event <> null)
				echo "EVENT SPESIAL"; ?>
					...
					<div style="text-align: center; width: 300px;">
						<?php
						echo form_open('bimbel/addplaylist_bimbel');
						?>
						<div>
...
<script>
	...
	$(document).on('change input', '#isemester', function () {
		document.getElementById('tbupdate').innerText = "Update";
	});
