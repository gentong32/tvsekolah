		...
		<div class="wb_LayoutGrid1">
			<div class="LayoutGrid1">
				<div class="row" style="margin-bottom:0px;padding-bottom: 0px;">
					<select <?php if($dafmarketing->status==1) echo 'disabled';?> style="margin:auto;max-width: 200px;" class="form-control" name="isiag" id="isiag">
		...
		<div class="wb_LayoutGrid1">
			<div class="LayoutGrid1">
				...
				<div class="form-group">
					<label for="inputDefault" class="col-md-12 control-label">NPSN / KODE PRODI / NOMOR YAYASAN
						<span style="color: red" id="npsnHasil"></span></label>
					<div style="max-width: 200px;margin:auto">
						<input <?php if($dafmarketing->status==1) echo 'disabled';?> type="text" class="form-control" id="inpsn" name="inpsn"
																maxlength="8"
				...
				<div class="form-group" id="ketsekolahbaru" style="display:none;">
					<div id="ketsekolah" style="font-weight:bold;color: #ff2222">Nomor kode salah atau belum terdaftar</div>
				...
				<div class="form-group" id="dkotasekolah" >
					...
					<div class="col-md-12" style="margin-bottom: 20px;">
						<input readonly type="text" class="form-control" id="ikotasekolah" name="ikotasekolah"
							   maxlength="100"
				...
				<div id="dsekolahbaru" style="display: none;">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="text" class="form-control" id="ikecamatansekolah" name="ikecamatansekolah"
								   maxlength="100" value="">
						</div>
					</div>
					...
					<div class="form-group">
						<label for="inputDefault" class="col-md-12 control-label">Alamat Sekolah/Lembaga</label>
						<div class="col-md-12">
							<input type="text" class="form-control" id="ialamatsekolah" name="ialamatsekolah"
								   maxlength="100" value="">
						</div>
					</div>
		...
		<div class="wb_LayoutGrid1">
			<div class="LayoutGrid1">
				...
				<div id="kode1" style="font-size: 14px;"><?php echo $http;?>login/registrasi/guru/<?php
					echo $dafmarketing->kode_referal; ?></div><br>
