...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
				<div id="tempatsoal" style="opacity:80%;padding-bottom:20px;color: black;">
...
<script>
	...
	function panggilsoal() {
		...
		isihtmlsoal = "<div style='margin-top:20px;' class='wb_LayoutGrid1'>" + " \r\n" +
			...
			"<div class='col-1'>" + " \r\n" +
			<?php if ($asal == "owner") {?>
			"<button onclick='kembalichannel()' class='btn-main' id='tbulangi'>KEMBALI</button> \n" +
			<?php } ?>
			"<center>\n" +
			"\t\t\t\t\t\t\t<div style=\"font-size: 14px;\">\n" +
			"\t\t\t\t\t\t\t\tSoal Latihan<br>\n" +
	...
	function kembalichannel() {
		...
		{ ?>
		window.open("<?php echo base_url() . 'virtualkelas/soal/buat/' . $linklist . $alamat;?>", "_self");
		<?php } ?>
