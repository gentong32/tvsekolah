...
$txt_sebagai = Array('', 'Guru/Dosen', 'Siswa/Mahasiswa', 'Umum', 'Staf');
...
foreach ($dafuser as $datane) {
	...
	if ($datane->verifikator == 0 && $datane->kontributor == 0)
		$statuse[$jml_user] = "-";

	if ($datane->bimbel<3)
		$statuse2[$jml_user] = "Calon Tutor";
	else
		$statuse2[$jml_user] = "Tutor Bimbel";
