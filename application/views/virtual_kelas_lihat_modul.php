		...
		<div class="container">
			...
			{ ?>
				<button class="btn-main"
						onclick="history.back();">Kembali
				</button>
			<?php }
			else
			{ ?>
			<button class="btn-main"
						onclick="window.location.href='<?php echo base_url(); ?>virtualkelas/modul_guru/chusr<?php echo $this->session->userdata('id_user');?>'">Tampilan Modul
				</button>
			<?php }
			?>
