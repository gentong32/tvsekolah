		...
		<div class="container">
			<div class="row">
				<div class="container" style="color:black;max-width: 900px">
					<center><span style="font-size:20px;font-weight:Bold;">SOAL LATIHAN<br><?php echo $judul; ?></span>
					</center>
					<!---->
					...
					<div id="dtambah" class="" style="margin-left:25px;margin-bottom: 30px;">
                ...
                <textarea style="max-width:800px;width:100%;margin:0;padding:0" type="text"
						  class="ckeditor" id="iisiopsie" name="iisiopsie" maxlength="1000"></textarea>
							...
							echo form_open('channel/updatesoal/' . $linklist . $alamats, $attributes);
							?>
					...
					<div style="margin-bottom: 15px;">
						Jika semua soal sudah dibuat, silakan klik tombol <b>Seting Soal</b> untuk mengubah Status Soal
						menjadi
						<b>"Publish"</b> agar bisa diakses.
					</div>
					<div id="dmenubawah" style="margin-left:25px;margin-bottom: 30px;">
						<button class="btn btn-danger" onclick="return kembalichannel();">Kembali ke Modul</button>
...
<script>
	...
	function kembalichannel() {
		...
		<?php }
		else if ($judul == "UTS" || $judul == "UAS" || $judul == "REMEDIAL UTS" || $judul == "REMEDIAL UAS"){
			if ($kodeevent=="evm"){?>
				window.open("<?php echo base_url() . 'virtualkelas/event/'.$bulanevent.'/'.$tahunevent;?>", "_self");
			<?php }
			else
			{ ?>
				window.open("<?php echo base_url() . 'virtualkelas/modul/';?>", "_self");
			<?php }
			?>
		...
		{?>
		window.open("<?php echo base_url() . 'virtualkelas/videomodul/' . $linklist.$alamat;?>", "_self");
		<?php } ?>

	}

	function setingsoal() {
		window.open("<?php echo base_url();?>virtualkelas/soal/seting/<?php echo $linklist . $alamats;?>", "_self");
	}

	function lihatsoal() {
		if (jmlsoal > 0)
			window.open("<?php echo base_url();?>virtualkelas/soal/tampilkan/<?php echo $linklist . '/' . $asal . $alamat;?>", "_self");
		else
			alert("Silakan membuat soal terlebih dahulu!");
	}

	function lihatnilai() {
		window.open("<?php echo base_url();?>virtualkelas/soal/nilaisiswa/<?php echo $linklist;?>", "_self");
	}
