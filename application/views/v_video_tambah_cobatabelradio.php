...
if ($addedit == "add") {
    ...
    $judule = "Edit Video";
    $sel_jenis[$datavideo['id_jenis']] = "checked='checked'";
    ...
    $sel_kd1_1[$datavideo['id_kd1_1']] = "checked='checked'";
                            ...
                            <div class="col-md-12" style='padding-bottom:5px;left:10px;'>
                                <table >
                                    <tr>
                                        <td style='width:auto'>
                                            <div id="isidkd1_1">
                                                <table class="tkd" style="border: 1px solid #e3e5e8;">
                                                <tbody>
                                                <?php
                                                if ($addedit == "edit")
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><input <?php echo $sel_kd1_1[$id_kd1[$b13]];?> type="radio" name="radio_kd1" value="<?php echo $id_kd1[$b13];?>"></td>
                                                        <td><?php echo $nama_kd1[$b13];?></td>
                                                    </tr>
                                                    <?php
                                                    }
                                                ?>
<!--                                                    <tr>-->
<!--                                                        <td><input type="radio" name="radio_kd1" value="1"></td>-->
<!--                                                        <td>memahami cara menghitung keliling dan luas lingkaran</td>-->
<!--                                                    </tr>-->
<!--                                                    <tr>-->
<!--                                                        <td><input type="radio" name="radio_kd1" value="2"></td>-->
<!--                                                        <td>memahami cara menghitung keliling dan luas segitiga siku-siku</td>-->
<!--                                                    </tr>-->
<!--                                                    <tr>-->
<!--                                                        <td><input type="radio" name="radio_kd1" value="2"></td>-->
<!--                                                        <td>siswa mampu memahami cara menghitung panjang, lebar, dan tinggi dari sebuah bangun ruang</td>-->
<!--                                                    </tr>-->
                                                    </tbody>
                                                </table>
                                            </div>
