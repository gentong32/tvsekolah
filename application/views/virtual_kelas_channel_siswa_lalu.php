				...
				<div>
					<div class="rowvod" style="margin-bottom: 40px;">
						...
						for ($a1 = 1; $a1 <= $jmldaf_list; $a1++) { ?>
							...
							<div class="columnvodbimbel">
								<div style="width:100%;margin:auto;margin-top:30px;position:relative;text-align:center">
									<div
										style="font-size:11px;background-color:black;color:white;position: absolute;right:20px;bottom:10px">
										<?php echo $durasidaf[$a1]; ?>
									</div>
									<img class="thumbbimbel" src="<?php echo $thumbnail[$a1]; ?>"><br>
								</div>
								<div style="text-align:center">
									<div class="judulvideo"><?php echo $nama_playlist[$a1]; ?></div>
								</div>
							</div>
