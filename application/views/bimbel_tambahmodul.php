...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
	<center>
		<span style="font-size:20px;font-weight:normal;"><?php echo $judule;?> PLAYLIST BIMBEL
		...
		<div style="text-align: center; width: 300px;">
			<?php
			echo form_open('virtualkelas/addmodul_bimbel');
			?>
			<div>
				<div class="well bp-component">
					<fieldset>
						<div class="form-group">
							...
							<div class="col-md-12">
								<input type="text" class="form-control" id="ipaket" name="ipaket" maxlength="100"
...
//									if ($addedit == "edit")
						...
						<div class="form-group" style="display: none">
							...
							<div class="col-md-12">
								<input type="text" value="<?php echo $tglpaket; ?>" name="datetime" id="datetime"
						...
						<input type="hidden" id="linklist_event" name="linklist_event" value="<?php echo $linklist_event;?>"/>
