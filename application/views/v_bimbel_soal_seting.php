...
echo form_open('bimbel/updateseting/' . $linklist . $alamat, $attributes);
?>
		...
		<div class="container">
			<div class="row">
				<div class="container" style="color:black;max-width: 900px">
					<center><span style="font-size:20px;font-weight:Bold;">Seting Soal Latihan Bimbel<br><?php echo $judul; ?></span>
					</center>
					<br>
