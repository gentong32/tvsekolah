...
//				echo '<hr style="height:1px;border:none;color:#366e8f;background-color:#366e8f;">';
	...
	<span style="font-weight: bold;color: black">MICRO LEARNING TERBARU</span>
		<div class="rowvod" style="margin-bottom: 40px;">
			...
			<a href="' . base_url() . 'channel/modul/sekolah/' . $id_videodaflist[$a1] . '">
			...
			<div class="grup" style="width:100%;margin:auto;margin-top:30px;position:relative;text-align:center">
			 ...
			 <div style="font-size:11px;color:white;position: absolute;top:10px;left:20px;bottom:10px">'
						. '<img width="20px" height="auto" src="' . $gembok1[$a1] . '"></div>
			 	<div style="font-size:11px;color:white;position: absolute;top:10px;left:30px;bottom:10px">'
						. '<img width="20px" height="auto" src="' . $gembok2[$a1] . '"></div>
			<img class="thumbbimbel" src="' . $thumbnail[$a1] . '"><br>
			</div>
			<div style="text-align:center">
			<div class="judulvideo">' . $nama_playlist[$a1] . '</div>
