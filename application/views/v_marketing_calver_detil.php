		...
		<div class="container">
			<div class="row">
				...
				<div style="color:#000000;margin:auto;background-color:white;">
					<br>
					<center><span style="font-size:16px;font-weight: bold;">DETIL KEGIATAN CALON VERIFIKATOR<br>
						</span>
				</center>
					...
					<div id="tabel1" style="font-size:1em;margin-left:1px;margin-right:1px;">
						<table id="tbl_user" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
							...
							<tr>
								...
								<th style='text-align:center'>Video Kontributor</th>
								<th style='text-align:center'>Siswa Ekskul</th>
							</tr>
							</thead>
						</table>
					</div>
	...
	$(document).ready(function () {
		...
		foreach ($dafcalver as $datane) {
			...
			echo "data.push([ " . $jml_user . ", \"" . $nama .
				"\", \"" . $datane->jmlvideocalver .
				"\", \"" . $datane->jml_playlist .
				"\", \"" . $datane->jml_kontri .
				"\", \"" . $datane->jml_video_kontri .
				"\", \"" . $datane->jml_ekskul."\"]);";
		}
		?>
