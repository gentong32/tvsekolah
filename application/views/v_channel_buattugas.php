...
<div class="container" style="color:black;margin-top: 60px; max-width: 900px">
	<center><span style="font-size:20px;font-weight:Bold;">URAIAN TUGAS SEKOLAH<br><?php echo $judul; ?></span></center>
	<!---->
		...
		<div class="row">
			<div class="form-group" style="margin-top: 10px;">
				...
				<label for="inputDefault" class="col-md-12 control-label">
					<div id="soalnomor" style="margin-bottom:15px;text-align: center;font-weight: bold;font-size: larger">TUGAS</div>
				</label>
...
<script>
	...
	function lihattugas() {
		window.open("<?php echo base_url();?>channel/tugas/saya/tampilkan/<?php echo $linklist.$tambahalamat;?>","_self");
	}
