...
$faktorpengali=$faktorpengali*$jmlmapelaktif*4;
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			...
			<center>
				<?php
				if ($kodeprem=="PRO") { ?>
					<div style="color:green;margin-top: -10px;margin-bottom: 20px">
						Status sekolah Anda adalah "PRO".<br>
						Silakan pilih paket lain jika ingin membeli sendiri.
					</div>
				<?php } else if ($kodeprem=="PRE") { ?>
					<div style="color:green;margin-top: -10px;margin-bottom: 20px">
						Status sekolah Anda adalah "PREMIUM".<br>
						Silakan pilih paket lain jika ingin membeli sendiri.
					</div>
				<?php } ?>
		...
		$('img.Image1').click(function (event) {
			...
			if (harga[this.id] == 0 && strata == "") {
				...
				if (this.id == "pro" && strata != "pro") {
					<?php if ($tvpremium == "PROEB" || $tvpremium == "PROEB2" || $tvpremium == "PRO") {?>
					...
					<?php }
					else if ($kodeprem != "PRO" && $kodeprem != "PRE") {?>
					//////////////// JIKA REGULER BIASA /////////////
					$.ajax({
