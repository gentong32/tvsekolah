...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
				<div class="container"
					 style="padding-top:20px;color:black;margin:auto;text-align:center; max-width: 900px">
					<center><span style="font-size:20px;font-weight:Bold;">TUGAS<br><?php echo $judul; ?></span>
					</center>
...
<script>
	...
	function lihatjawaban() {
		if (document.getElementById('tbupdate').style.display == "none")
			window.open("<?php echo base_url();?>virtualkelas/tugas/<?php echo $npsn;?>/jawabansaya/<?php echo $linklist;?>", "_self");
		else
			alert ("Silakan klik tombol Update dulu");
	}
