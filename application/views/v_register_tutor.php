...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
				<?php
				echo form_open('login/tambahuser_umum/tutor', array('autocomplete' => 'off', 'id' => 'myform'));
				?>
				<div class="container" style="max-width:600px;padding-bottom: 20px;	">
					<center>
						<span style="font-size: 18px;font-weight: bold;color: black">Mendaftar Sebagai Tutor Bimbel Online</span>
					</center>
					<fieldset style="background-color: white;margin-top: 20px">
						...
						<?php if ($this->session->userdata('sebagai') == 1) { ?>
							<div class="form-group" style="padding-top: 20px;">
								...
								<div class="col-md-12">
									<input disabled autocomplete="false" autofill="false" type="text"
										   class="form-control"
										   id="iemail" name="iemail" maxlength="50" value="<?php
									echo $this->session->userdata('email'); ?>" placeholder="Alamat Email">
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									...
									echo $this->session->userdata('first_name'); ?>" type="text"
										   class="form-control" id="ifirst_name" name="ifirst_name"
										   maxlength="25" placeholder="Nama Depan">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-12">
									<input disabled value="<?php
									echo $this->session->userdata('last_name'); ?>" type="text"
										   class="form-control" id="ilast_name" name="ilast_name"
										   maxlength="25"
						...
						<?php } else {
							...
							<div class="form-group">
								<label for="inputDefault" class="col-md-12 control-label">Nama depan<span
									...
									<span style="color: red" id="firstnameHasil"></span></label>
								<div class="col-md-12">
									<input type="text" class="form-control" id="ifirst_name"
										   name="ifirst_name"
										   maxlength="25"
							...
							<div class="form-group">
								<label for="inputDefault" class="col-md-12 control-label">Nama belakang
									<span style="color: red" id="lastnameHasil"></span></label>
								<div class="col-md-12">
									<input type="text" class="form-control" id="ilast_name"
										   name="ilast_name"
										   maxlength="25"
										   placeholder="Nama Belakang">
								</div>
							...
							<div class="form-group">
								<label for="inputDefault" class="col-md-12 control-label">Repeat
									Password<span
										style="color:red">*</span></label>
								<div class="col-md-12" style="width:200px">
							...
							<div class="form-group">
								<label for="inputDefault" class="col-md-12 control-label">Alamat Rumah<span
										style="color:red">*</span>
									<span style="color: red"></span></label>
								<div class="col-md-12">
							...
							<div class="form-group">
								<label for="inputDefault" class="col-md-12 control-label">Instansi
									<span style="color: red"></span></label>
								<div class="col-md-12">
							...
							<div class="form-group">
								<label for="inputDefault" class="col-md-12 control-label">Nomor KTP<span
									...
									<span style="color: red"></span></label>
								<div class="col-md-12">
									<input type="text" class="form-control" id="iktp" name="iktp"
										   maxlength="50"
						...
						<div class="form-group">
							...
							<div class="col-md-12" style="width:300px;padding-bottom: 10px;">
								<?php
								echo $recaptcha_html;
								?>
							</div>
...
<script>
	...
	function cekregister() {
		...
		if ($('#ifirst_name').val() == "" || $('#email').val() == "" || $('#ipassword').val() == ""
			|| $('#ihape').val() == "" || $('#ialamat').val() == "" || $('#iktp').val() == "") {
	...
	function takon() {
		window.open("<?php echo base_url();?>peluangkarir/tutor", "_self");
		return false;
	}
