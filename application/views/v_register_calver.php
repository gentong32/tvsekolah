	...
	<section aria-label="section" class="pt30">
		<div class="container" style="max-width:600px;padding-bottom: 20px;	">
			<div class="row">
				...
				if ($referrer!=null)
				{
					echo "<h3>Sudah mendaftar sebagai calon verifikator? <a href='".base_url()."login'>Login di sini!</a></h3>";
				}
				echo form_open('login/tambahuser', array('autocomplete' => 'off', 'id' => 'myform'));
				?>

				<legend><span
						style="font-weight: bold;color: black">Mendaftar Sebagai Calon Verifikator</span>
				</legend>
				<fieldset style="background-color: white;margin-top: 20px">
					...
					<input type="hidden" id="referrer_calver" name="referrer_calver" value="<?php echo $referrer_calver; ?>"/>
					<input type="hidden" id="jabatan" name="jabatan" value="calver"/>
