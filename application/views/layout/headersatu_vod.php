...
<!--				<span class="icon-bar"></span>-->
		...
		<div class="navbar-collapse collapse" id="navbar-main">
			<ul class="nav navbar-nav">
				...
				<?php if ($this->session->userdata('activate')==1 && ($this->session->userdata('a01') || $this->session->userdata('a02') || $this->session->userdata('a03'))) { ?>
                    <li class="dropdown" style="font-size: 15px; font-weight: bold">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><span style="color:<?php echo $warna[0];?>">Menu</span><span
						...
						<ul class="dropdown-menu" aria-labelledby="themes" >
                            <?php if ($this->session->userdata('a01') || $this->session->userdata('a02'))  { ?>
                                <?php if ($this->session->userdata('a01')) { ?>
                                    <li><a href="<?php echo base_url(); ?>statistik"><span class="menuku" style="color:black">Statistik</span></a>
                                    </li>
                                <?php } ?>
                                <?php if ($this->session->userdata('a01') || $this->session->userdata('a02')) { ?>
						...
						if ($this->session->userdata('a02') && !$this->session->userdata('a01')) {
							...
							<li>
								<a href="<?php echo base_url(); ?>channel/playlistsekolah">
									<span class="menuku" style="color:black">Playlist Sekolah</span></a></li>
                            <li>
							...
							<li>
								<a href="<?php echo base_url(); ?>channel/playlisttve">
									<span class="menuku" style="color:black">Playlist TVE</span></a></li>
							<?php } ?>
				...
				<?php if ($this->session->userdata('a01')) { ?>
					<li class="dropdown" style="font-size: 15px; font-weight: bold">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><span style="color:<?php echo $warna[0];?>">Pengaturan</span><span
								class="caret" style="color: #5f5f5f"></span></a>
						<ul class="dropdown-menu" aria-labelledby="themes">
							<li><a href="<?php echo base_url(); ?>seting/penilaian"><span class="menuku" style="color:black">Daftar Pertanyaan</span></a></li>
				<li><a href="<?php echo base_url(); ?>seting/jurusansmk"><span class="menuku" style="color:black">Daftar Jurusan SMK</span></a></li>
                            <li><a href="<?php echo base_url(); ?>seting/daftarsekolah"><span class="menuku" style="color:black">Daftar Sekolah</span></a></li>
                            ...
                            <li><a href="<?php echo base_url(); ?>seting/url_live"><span class="menuku" style="color:black">TVE Live</span></a></li>
                            <hr>
                            <li><a href="<?php echo base_url(); ?>promo"><span class="menuku" style="color:black">Daftar Promo</span></a></li>
                            <li><a href="<?php echo base_url(); ?>news"><span class="menuku" style="color:black">Daftar Berita</span></a></li>
						</ul>
					</li>
				<?php } ?>
                <li style="font-size: 15px; font-weight: bold">
                ...
                <li style="font-size: 15px; font-weight: bold">
                    <a href="<?php echo base_url(); ?>channel"><span style="color:<?php echo $warna[4];?>">TVE Berjaringan</span></a>
                </li>
				<li style="font-size: 15px; font-weight: bold">
...
<?php if ($this->session->userdata('a01x')) { ?>
...
<div style="left:15px;top:70px;position: fixed;z-index: 90;background-color: white;border: 1px solid black ">
    <span style="color:black;margin-top:70px;font-size:20px;cursor:pointer" onclick="openNav()">&nbsp &#9776; Menu &nbsp</span>
</div>
