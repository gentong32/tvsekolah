		...
		<section aria-label="section" class="mt0 sm-mt-0">
			<div class="container">
				<div class="row">
					...
					<div>
						<button style="float:right;margin-right:10px;" class="btn-main"
							onclick="window.location.href='<?php echo base_url().'event/spesial/'.$link_event.'/'.$hal;?>'">Upload Video
						</button>
					</div>
				</div>
					<center>
						<h4>ANDA BELUM MEMILIKI VIDEO</h4>
						<br>
						<h5>Silakan klik tombol Upload Video.<br>
							Pastikan statusnya sudah Siap Tayang dengan cara meminta Verifikator Sekolah agar Video anda diverifikasi. </h5>
					</center>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					...
					<div style="margin-bottom: 10px;">
						<button class="btn btn-main" onclick="window.location.href='<?php echo base_url(); ?>event/playlist/<?php echo $link_event.'/'.$hal; ?>'">Kembali
						</button>

						<button
							onclick="window.location.href='<?php echo base_url(); ?>event/urutanplaylist/<?php echo $kodepaket.'/'.$link_event.'/'.$hal; ?>'"
					...
					<div style="font-size: 12px; margin-bottom: 20px;">
						<i>Keterangan:</i><br>
						 <img style="height: 20px; width: auto;" src="<?php echo base_url('assets/images/icohijau.png'); ?>"> Belum masuk playlist hari ini<br>
						 <img style="height: 20px; width: auto;" src="<?php echo base_url('assets/images/icomerah.png'); ?>"> Belum masuk, tapi sudah pernah dipakai di hari lain<br>
						<img style="height: 20px; width: auto;" src="<?php echo base_url('assets/images/icomasuk.png'); ?>"> Masuk daftar playlist<br>
					</div>
...
<?php require_once('layout/calljs.php'); ?>
	...
	<script>
		...
		function masukinlist(idx) {
			...
			$.ajax({
				url: "<?php echo base_url(); ?>channel/masukinlist_sekolah",
				method: "POST",
