...
{ ?>
	...
	<br>
		<center>
			<span style="font-size:16px;font-weight: bold;">ANDA BELUM MEMILIKI VIDEO (PRIBADI)</span>
		</center>
	<br>
		<center>
			<span style="font-size:16px;font-weight: bold;">Silakan Tambahkan Video pada menu Daftar Video Saya atau melalui Upload Video pada Event.<br>
				Kemudian pada kolom Sifat diubah dari Publik menjadi Pribadi terlebih dahulu.<br><br>
			Untuk dapat tampil pada Channel Guru pastikan Video anda statusnya sudah Siap Tayang. Mintalah Verifikator Sekolah agar Video anda diverifikasi. </span>
		</center>
	</div>
<?php 
die();
...
<div style="color:#000000;margin-left:10px;margin-right:10px;background-color:white;margin-top: 60px;">
	...
	<button type="button" onclick="return kembali();" style="float:left;margin-right:10px;margin-top:-20px;">Kembali
	</button>

	<?php if($kodeevent==null) { ?>
    <button type="button" onclick="window.location.href='<?php echo base_url();?>channel/urutanplaylist_guru/<?php echo $kodepaket;?>'" class=""
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">
						...
						echo $warnane[$i];?>" onclick="masukinlist('<?php echo $id_video[$i]; ?>')" type="button"><?php echo $idchannel[$i]; ?></button>
