...
<div class="container bgimg3" style="margin-top: 0px;width: 100%">
	...
	<div id="LayoutGridPilih" style="color: black;">
		<div id="LayoutGridPilih" style="width: 100%">
			<div class="row">
				<div class="col-1">
					...
					position: absolute;right:20px;bottom:35px"><?php echo $durasidaf[1]; ?></div>
									...
									<img style="margin-top:0px;margin-bottom:20px;width: 100%;max-width:400px" ;
										 src="<?php
										 if ($id_playlist == null)
					...
					position: absolute;right:20px;bottom:35px"><?php echo $durasidaf[1]; ?></div>
									...
									<img style="margin-top:0px;margin-bottom:20px;width: 100%;max-width:500px" ;
										 src="<?php
										 if ($id_playlist == null)
											 echo $thumbnail[$idliveduluan]; else
											 echo $thumbspaket; ?>"/>
...
<script>
	...
	function kerjakansoal() {
		window.open("<?php echo base_url();?>vksekolah/soal/<?php echo $id_playlist . '/' . $asal;?>", "_self");
	}

	function bukamateri() {
		window.open("<?php echo base_url();?>vksekolah/materi/tampilkan/<?php echo $id_playlist;?>", "_self");
	}
