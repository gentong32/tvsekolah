		...
		<div class="container">
			<div class="row">
				...
				<div style="margin-bottom: 10px;">
					...
					<button class="btn-main"
							onclick="window.location.href='<?php echo base_url(); ?>virtualkelas/modul_guru/chusr<?php
							echo $this->session->userdata('id_user'); ?>'">Lihat Modul Aktif
					</button>
				</div>
				<hr>
				<div style="margin-bottom: 10px;">
...
//							$materi[$i].", STATUSTUGAS:".$status_tugas[$i]."<br>";
						...
						<tr>
							...
							<td>
								...
								{ ?>
									<button
										onclick="window.open('<?php echo base_url(); ?>channel/inputplaylist/<?php echo $link_paket[$i]; ?>', '_self')"
										id="thumbnail" type="button">Video
									</button>
									<button
										onclick="window.open('<?php echo base_url(); ?>channel/modul/sekolah/<?php echo $link_paket[$i]; ?>', '_self')"
										id="thumbnail" type="button">Lihat Modul
									</button>
									<button
										onclick="window.open('<?php echo base_url(); ?>channel/materi/buat/<?php echo $link_paket[$i]; ?>', '_self')"
										id="thumbnail3" type="button">Materi
									</button>
									<button
										onclick="window.open('<?php echo base_url(); ?>channel/soal/buat/<?php echo $link_paket[$i]; ?>', '_self')"
										id="thumbnail4" type="button">Soal
									</button>
									<button
										onclick="window.open('<?php echo base_url(); ?>channel/tugas/saya/tampilkan/<?php echo $link_paket[$i]; ?>', '_self')"
