...
<div class="midde_cont">
	<div class="container-fluid">
		...
		<div class="row column2 graph margin_bottom_30">
			...
			<?php if($this->session->userdata('sebagai')==1 && $this->session->userdata('verifikator')!=1 && ($verifikator_aktif==0 || $verifikator_aktif==1 || 
			 ($verifikator_aktif==2 && $this->session->userdata('kontributor')==2) || 
			 ($verifikator_aktif==3 && $this->session->userdata('kontributor')==2)))
				{?>
					...
					<div class="full price_table padding_infor_info">
						<div class="row">
							...
							<div class="col-lg-12" style="font-size: 18px;">
								<?php if($verifikator_aktif==0 && $this->session->userdata('verifikator')!=1)
									{?>
									...
									<?php }
									else if($verifikator_aktif==1 && $this->session->userdata('verifikator')!=3 && $this->session->userdata('verifikator')!=1)
									{?>
