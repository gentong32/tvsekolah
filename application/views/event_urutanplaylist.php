			...
			<div class="container">
				<div class="row">
					...
					<div style="margin-bottom: 10px;">
						...
						<button
							onclick="window.location.href='<?php echo base_url(); ?>event/inputplaylist/<?php echo $kodepaket.'/'.$link_event.'/'.$hal; ?>'"
					...
					<div style="margin-bottom: 10px;">
						<button type="button" onclick="updatedata()" class="btn btn-main"
