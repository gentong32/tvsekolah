				...
				<fieldset>
					...
					<div class="form-group">
						...
						<textarea rows="4" cols="60" class="form-control" id="ideskripsi" name="ideskripsi"
								  maxlength="200"><?php echo $deskripsi; ?></textarea><br>
						</div>
					</div>
					...
					<div class="form-group">
						<label for="inputDefault" class="col-md-12 control-label">Link Youtube</label>
						<div class="col-md-12">
							<textarea <?php
							if ($addedit == "edit") {
					...
					//echo 'ID:'.youtube_id($link_video).", ";
					//echo 'Durasi:'.$data['info'] = $this->getVideoInfo(youtube_id($link_video));
					?>
					...
					<label for="inputDefault" class="col-md-12 control-label">Thumbnail</label>
					<div class="col-md-12">
						<img id="img_thumb" style="align:middle;width:200px;" src="<?php echo base_url(); ?>assets/images/blank.jpg">
						<!--					&nbsp;<button class="btn btn-default" onclick="return upload()">Upload Thumbnail</button>-->
					...
					<!--					<input style="display:inline;width:20px;height:25px;margin:0;padding:0" type="text"-->
					<!--						   class="form-control" id="idurjam" name="idurjam" maxlength="2"-->
					<!--						   value="--><?php //echo $durjam;
					?><!--" placeholder="00">-->
					<!--					:-->
					<!--					<input style="display:inline;width:20px;height:25px;margin:0;padding:0" type="text"-->
					<!--						   class="form-control" id="idurmenit" name="idurmenit" maxlength="2"-->
					<!--						   value="--><?php //echo $durmenit;
					?><!--" placeholder="00">-->
					<!--					:-->
					<!--					<input style="display:inline;width:20px;height:25px;margin:0;padding:0" type="text"-->
					<!--						   class="form-control" id="idurdetik" name="idurdetik" maxlength="2"-->
					<!--						   value="--><?php //echo $durdetik;
					?><!--" placeholder="00">-->
					<!--					<br><br></div>-->
			</div>
			<?php }
