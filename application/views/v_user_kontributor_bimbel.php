...
<div class="no-bottom no-top" id="content">
	...
	<section aria-label="section" class="pt30">
		<div class="container">
			<div class="row">
				<br>
				<center><span style="font-size:20px;font-weight: bold;">Daftar Guru Modul Bimbel</span>
					<div style="margin-bottom: 20px;"><button class="btn-info"
						  onclick="window.location.href='<?php echo base_url().'user/kontributorsekolah/dashboard';?>'">Guru Modul Sekolah
						</button>
					</div>
				</center>
...
<script>
	...
	function bukamodul(id) {
		window.open('<?php echo base_url()."bimbel/modul_saya/";?>'+id,'_self');
	}
