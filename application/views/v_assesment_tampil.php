								...
								<div class="col-1">
									<center>
										<div style="font-size: 14px;">
											ASSESMENT <?php echo substr($asseske, 1, 1); ?>
										</div>
										<hr>
									</center>
									<div class="wb_Text1">
...
<script>
	...
	function selesai() {
		window.open("<?php echo base_url() . 'seting/soal/buat/' . $asseske;?>", "_self");
	}
	...
	function panggilsoal() {
		...
		isihtmlsoal = "<div style='margin-top:20px;' class='wb_LayoutGrid1'>" + " \r\n" +
			...
			"<div class='col-1'>" + " \r\n" +
			<?php if ($asal == "owner") {?>
			"<button onclick='kembalibimbel()' id='tbulangi'>KEMBALI</button> \n" +
			<?php } ?>
			"<center>\n" +
			"\t\t\t\t\t\t\t<div style=\"font-size: 14px;\">\n" +
			"\t\t\t\t\t\t\t\tSoal Latihan<br>\n" +
			"\t\t\t\t\t\t\t\t\t<span style=\"font-size: 18px;\">ASSESMENT <?php echo substr($asseske, 1, 1);?></span>\n" +
			"\t\t\t\t\t\t\t</div>\n" +
			"\t\t\t\t\t\t\t<hr>\n" +
			"\t\t\t\t\t\t</center>" +
			"<div class='wb_Text1'>" + " \r\n" +
	...
	function hasilakhir() {
		...
		isihtmlsoal = '<div style="margin-top:20px;margin-bottom:0px;" class="wb_LayoutGrid1">\n' +
			...
			'ASSESMENT <?php echo substr($asseske, 1, 1);?></span><br><hr><br>' +
