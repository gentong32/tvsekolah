			...
			<div class="col-md-l2 col-lg-12">
				<div class="row">
					<div class="col-md-6 col-lg-3">
						<a href="<?php echo base_url() . "profil/pembayaran"; ?>">
							<div class="full counter_section margin_bottom_30">
								...
								<div class="counter_no">
									<div>
										<p class="total_no"><?php echo $keteranganbayar1; ?></p>
										<p class="head_couter"><?php echo $keteranganbayar2; ?></p>
									</div>
								</div>
							</div>
						</a>
					...
					<div class="col-md-6 col-lg-3">
						<?php if ($status_verifikator == "belumokes") { ?>
						<a href="#" onclick="alert('Silakan lakukan pembayaran terlebih dahulu');">
							<?php } else if ($jumlahvertotal > 0){ ?>
							<a href="<?php echo base_url() . "profil/verifikasi"; ?>">
								<?php } ?>
								<div class="full counter_section margin_bottom_30">
									<div class="couter_icon">
										<div>
											<i class="fa fa-youtube-play orange_color"></i>
										</div>
									</div>
									<div class="counter_no">
										<div>
											<p class="total_no"><?php echo $jumlahvertotal; ?></p>
					...
					<div class="col-md-6 col-lg-3">
						<a href="<?php echo $linkguru; ?>">
							<div class="full counter_section margin_bottom_30">
								...
								<div class="counter_no">
									<div>
										<p class="total_no"><?php echo $keteranganguru1; ?></p>
										<p class="head_couter"><?php echo $keteranganguru2; ?></p>
									</div>
								</div>
							</div>
						</a>
									...
									<li><strong>Status Sekolah</strong><br>
										...
										<?php if (isset($aku)) { ?>
											<div>
												...
												<br/>IFrame<textarea id="url" rows="1" cols="30"></textarea>
											</div>
										<?php } ?>
									</li>
								</ul>
...
<!--										</a>-->
							...
							<?php if ($status_dibayarin_donatur == "oke") {
								?>
								<div class="task_list_main">
									<ul class="task_list">
										<li>
											<strong>Dana iuran dari Donatur</strong><br>
												<?php echo $keterangandonatur; ?>
										</li>
									</ul>
								</div>
							<?php }
