		...
		<div id="wb_LayoutGrid1">
			<div id="LayoutGrid1">
				<div class="row">
						...
						<div class="col-1">
							<div class="wb_Image1" style="display:inline-block;width:200px;height:270px;z-index:0;">
								<a href="<?php echo base_url() . 'login/register/umum_ae'; ?>"><img
										src="<?php echo base_url() . 'assets/images/tblowong1.png'; ?>" class="Image1"
										alt=""></a>
							</div>
						</div>
						<div class="col-2">
							<div class="wb_Image1" style="display:inline-block;width:200px;height:270px;z-index:2;">
								<a href="<?php echo base_url() . 'login/register/umum_am'; ?>"><img
										src="<?php echo base_url() . 'assets/images/tblowong2.png'; ?>" class="Image1"
										alt=""></a>
							</div>
						</div>
						<div class="col-3">
							<div class="wb_Image1"
								 style="font-size:15px;font-weight:bold;display:inline-block;width:200px;height:270px;z-index:1;">
								<a href="<?php echo base_url() . 'informasi/lowongan_bimbel'; ?>"><img
										src="<?php echo base_url() . 'assets/images/tblowong3.png'; ?>" class="Image1"
									 alt=""></a>
							</div>
						</div>
